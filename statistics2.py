...
def calc_Count(data):
    ...
    for i in range(4):
        ...
        exercise_count[t_list[i]] += exercise_minute[i] + \
            round(exercise_second[i]*0.01, 3)
...
part_name3[0] = part_name[0]
part_name3[1] = part_name[1]
part_name3[2] = part_name[2]

file_data["part_name"] = part_name3
file_data["time_exercise_name"] = time_exercise_name
file_data["time_exercise_minute"] = time_exercise_minute
file_data["time_exercise_second"] = time_exercise_second
file_data["time_exercise_freq"] = time_exercise_freq
file_data["count_exercise_name"] = count_exercise_name
file_data["count_exercise_count"] = count_exercise_count
file_data["count_exercise_freq"] = count_exercise_freq

with open('file516.json', 'w', encoding="utf-8") as make_file:
